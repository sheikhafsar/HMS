                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Nurse Info</strong> Form
                                    </div>
                                    <div class="card-body card-block">
                                        <form name="frm1" action="insert_nur.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
											<!--Nurse Id-->
											<div class="row form-group">
                                                <div class="col col-md-2">
                                                    <label class=" form-control-label">Nurse Id</label>
                                                </div>
                                                <div class="col-3 col-md-2">
                                                    <p class="form-control-static">NUR</p>
                                                </div>
												<div class="col-6 col-md-2">
                                                    <input type="text" id="ID" name="ID" placeholder="Nurse Id" class="form-control">
                                                </div>
