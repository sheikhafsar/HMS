                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">
												<a href="reception.php">Receptionist</a>
											</li>
											<li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
											<li class="list-inline-item">
												<a href="insert_rec.php">Add Receptionist</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Receptionist Info</strong> Form
                                    </div>
                                    <div class="card-body card-block">
                                        <form name="frm1" action="insert_rec.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
											<!--Nurse Id-->
											<div class="row form-group">
                                                <div class="col col-md-2">
                                                    <label class=" form-control-label">Rec Id</label>
                                                </div>
                                                <div class="col-3 col-md-2">
                                                    <p class="form-control-static">REC</p>
                                                </div>
												<div class="col-6 col-md-2">
                                                    <input type="text" id="ID" name="ID" placeholder="Rec Id" class="form-control">
                                                </div>
