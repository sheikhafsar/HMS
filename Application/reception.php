                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                         <h3 class="title-5 m-b-35">Receptionist Details</h3>
                                    </div>
                                    <div class="table-data__tool-right">
									<form name="delefrm1te" action="reception.php" method="POST">
                                    <?php
                                        require_once 'Connect.php';
									...
									?>
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i><a href="insert_rec.php">add Receptionist</a>
										</button>
										<button type="submit" name="delete" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i>Delete receptionist
										</button>
									</div>
                                </div>
								<!--Inserted new table-->
                                            ...
                                            <tr class="tr-shadow">
                                                <td>
                                                    <label class="au-checkbox">
                                                        <input type="checkbox" name="receptionist[]" value="<?php echo "$row[rec_id]" ?>" />
