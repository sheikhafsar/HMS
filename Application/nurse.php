                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                         <h3 class="title-5 m-b-35">Nurse Details</h3>
                                    </div>
                                    <div class="table-data__tool-right">
									<form name="delete" action="nurse.php" method="POST">
									<?php
									...
									?>
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i><a href="insert_nur.php">add Nurse</a>
										</button>
										<button type="submit" name="delete" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i>Delete Nurse
										</button>
									</div>
                                </div>
								<!--Inserted new table-->
                                            ...
                                            <tr class="tr-shadow">
                                                <td>
                                                    <label class="au-checkbox">
                                                        <input type="checkbox"  name="nurse[]" value="<?php echo "$row[nurse_id]" ?>"/>
														<span class="au-checkmark"></span>
													</label>
												</td>
                                                <td>
                                                    <?php echo $row["nurse_id"]; ?></td>
                                                <td>
                                                   <?php 
														echo $row["first_name"];
														echo " ";
