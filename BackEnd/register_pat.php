                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="fnm" placeholder="First Name" required>
                                </div>
                                <div class="form-group">
                                    <label>Last Name</label>
                                    <input class="au-input au-input--full" type="text" name="lnm" placeholder="Last Name" required>
                                </div>
                                
                                <div class="form-group">
                                    <label>Gender </label>
                                    <input class="au-input au-input--full" type="radio" name="gender" value="male" checked> Male<br>
                                    <input class="au-input au-input--full" type="radio" name="gender" value="female"> Female<br>
                                    <input class="au-input au-input--full" type="radio" name="gender" value="other"> Other  
                                </div>
                                
                                <div class="form-group">
                                    <label>Birthday</label> 
                                        <input class="au-input au-input--full" type="date" name="bday">
                                </div>
                                
                                <div class="form-group">
                                    <label>Phone</label> 
                                        <input class="au-input au-input--full" name="phone" type="tel" size="10">
                                  </div>
                                ...
                                <p>
                                    ...
                                    <a href="login_pat.php">Sign In</a>
                                </p>
                            </div>
                            </form>
                        </div>
