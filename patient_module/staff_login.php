<?php
 ...
 if (isset($_POST["submit"])) {
     ...
     $stmt = $DBcon->prepare("select * from staff where username=:nm and password=:pwd");
    ...
    if($count==1)
    {
        ...
        if (preg_match('#^DOC#i', $_SESSION["id"]) === 1)
        header('location:doc_dashboard.php');
        
        if (preg_match('#^REC#i', $_SESSION["id"]) === 1)
        header('location:rec_dashboard.php');
        
        if (preg_match('#^NUR#i', $_SESSION["id"]) === 1)
...
<body background="images/departments_bg2.jpg" class="animsition" >
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form name="login" action="staff_login.php" method="POST">
