                ...
                <div class="row">
                    <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                        <div class="site-branding d-flex align-items-center">
                           <a class="d-block" href="index.html" rel="home"><!--<img class="d-block" src="images/logo.png" alt="logo">--><h3>HMS</h3></a>
                        </div><!-- .site-branding -->
                            ...
                            <div class="row h-100">
                                <div class="col-12 col-lg-6 d-flex flex-column justify-content-center align-items-start">
                                    <header class="entry-header">
                                        <h1>Medical Services<br><b>That You Can <span style="color:red;">Trust</span></b></h1>
                                    </header><!-- .entry-header -->

                                    <div class="entry-content mt-4">
                                        <p>Your most trusted health partner for life. Small enough to care.<br>Large enough to heal. Bright minds medicine.</p>
                                    </div><!-- .entry-content -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 mt-5 mt-md-0">
                    <div class="emergency-box">
                        ...
                        <div class="call-btn button gradient-bg">
                            <a class="d-flex justify-content-center align-items-center" href="#"><img src="images/emergency-call.png"> +91-9423061244</a>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-5 mt-5 mt-lg-0">
                    <div class="appointment-box">
                        ...
                        <form name="form" action="index.php" method=POST class="d-flex flex-wrap justify-content-between">
                        <select name="dept" id="dept" class="form-control">
                            <!--<select class="select-department" id="dept">-->
                            ...
                            <select name="doctor" id="doctor" class="select-doctor">
                                <option>Select Doctor</option>
                                <option>Select Doctor 1</option>
                                <option>Select Doctor 2</option>
                            </select>
                            <br>
                            <input type="date" class="form-control-label" name="date" placeholder="Date">

                            <input type="time" class="form-control-label" name="time" placeholder="Time"><!--what is needeed here-->
                            <span><a style="text-decoration:none;text-color:white;" href="patient_login.php"><br><button class="button gradient-bg" name="submit" type="submit">Book Appointment</a></span>
                        </form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="our-departments-cont">
                                    ...
                                    <div class="entry-content">
                                        <p>A medical lab is a laboratory where tests are carried out on clinical specimens to obtain information about the health of a patient </p>
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="our-departments-cont">
                                    ...
                                    <div class="entry-content">
                                        <p>Surgery is a medical specialty that uses operative manual and instrumental techniques on a patient</p>
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="our-departments-cont">
                                    ...
                                    <div class="entry-content">
                                        <p>Neurology is a branch of medicine dealing with disorders of the nervous system.Neurology deals with the diagnosis </p>
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-md-0">
                                <div class="our-departments-cont">
                                    ...
                                    <div class="entry-content">
                                        <p>The branch of medicine that deal with the prevention of injuries of the skeletal system associated muscles and joints</p>
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-0">
                                <div class="our-departments-cont">
                                    ...
                                    <div class="entry-content">
                                        <p>Ophthalmology is a branch that deals with the anatomy, physiology and diseases of the eyeball and orbit.</p>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="foot-about">
                            <h2><a href="#"><!--<img src="images/logo.png" alt="">-->HMS</a></h2>

                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus mauris scelerisque, at rutrum nulla dictum. Ut ac ligula sapien.</p>

                            <p style="align:center;" class="copyright"> ©2018, HMS. All Rights Reserved.</p>
                        </div><!-- .foot-about -->
                    </div><!-- .col -->
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mt-5 mt-md-0">
                        <div class="foot-contact">
                            ...
                            <ul class="p-0 m-0">
                                ...
                                <li><span>Phone:</span>+91-94230 61244</li>
                                <li><span>Email:</span>contact@gmail.com</li>
                            </ul>
                        </div>
                    </div><!-- .col -->
