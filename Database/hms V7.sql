...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2018 at 08:50 AM
...
('DOC04', 'Anish', 'Rao', 'male', 'head', '60000.00', '7038137214', 'adsf@gmail.com', 'margao', '2018-10-13', 1, 'ar', 'ar123'),
...
ALTER TABLE `appointment`
  ...
  ADD KEY `dr_id` (`dr_id`),
  ADD KEY `appointment_ibfk_1` (`pat_id`);
